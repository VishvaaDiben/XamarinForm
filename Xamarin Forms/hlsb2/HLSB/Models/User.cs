...
namespace HLSB.Models
{
    public class User
    {
        ...
        public string ProfilePictureString
        {
            get
            {
                return Convert.ToBase64String(ProfilePicture ?? Convert.FromBase64String(DefaultProfilePicture));
            }
            set
            {
                ProfilePicture = Convert.FromBase64String(!String.IsNullOrEmpty(value) ? value : DefaultProfilePicture);
